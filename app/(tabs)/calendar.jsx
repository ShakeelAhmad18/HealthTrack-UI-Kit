...
const DUMMY_APPOINTMENTS = {
  complete: [
    ...
    },
    {
      ...
      isFavorite: true,
      profileImage:
        "https://images.unsplash.com/photo-1594824476967-cf298d022718?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ],
  upcoming: [
    {
...
const AppointmentScreen = () => {
  ...
  const handleAddReview = (doctorName) => {
    ...
    router.push({ pathname: 'Appointments/Review', params: { doctorName } });
  };

  const handleDetails = (appointmentId) => {

     router.push({ pathname: 'Appointments/AppointmentDetail', params: { appointmentId } });
  ...
  const handleCancelAppointment = (appointmentId) => {
    router.push({
      pathname: "Appointments/CancelAppointment",
