...
import {
  ...
  Dimensions,
  Platform,
  Alert, // Added for feedback, though not strictly required by the prompt
} from "react-native";
import {
  Ionicons,
...
const HomeScreen = () => {
  ...
  const categories = [
    ...
    { name: "Doctors", icon: "doctor", path: "doctors/Doctors" },
  ...
  const specialties = [
    ...
    { name: "Dermatology", icon: "hair-dryer" },
    { name: "General Medicine", icon: "stethoscope" },
    { name: "Gynecology", icon: "gender-female" },
    { name: "Odontology", icon: "tooth-outline" },
      ...
      >
        ...
        >
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity
              onPress={() =>
                Alert.alert("Schedule", "See all schedule for month")
              }
            >
          ...
          <View style={styles.appointmentList}>
            <View style={styles.sectionHeader}>
              ...
              <TouchableOpacity
                onPress={() => Alert.alert("Schedule", "See all appointments")}
              >
          ...
          <View style={styles.specialtiesGrid}>
            {specialties.map((specialty, index) => (
              <TouchableOpacity
                ...
                onPress={() =>
                  Alert.alert("Specialty", `${specialty.name} pressed`)
                }
              >
                <MaterialCommunityIcons
                  name={specialty.icon}
