// app/odontology-doctors.js (or app/doctors/odontology.js)
...
// Dummy Data for Odontology Doctors
const ALL_ODONTOLOGY_DOCTORS = [
  {
    id: "o1",
...
const OdontologyDoctorsScreen = () => {
  ...
  useEffect(() => {
    let filtered = ALL_ODONTOLOGY_DOCTORS.filter(
      (doctor) =>
...
export default OdontologyDoctorsScreen;
