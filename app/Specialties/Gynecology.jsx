// app/gynecology-doctors.js (or app/doctors/gynecology.js if using static routes)
...
// Dummy Data for Gynecology Doctors
const ALL_GYNECOLOGY_DOCTORS = [
  {
    id: "gyn1",
    name: "Dr. Ava Williams, M.D.",
    specialization: "Maternal-Fetal Medicine",
    profileImage:
      "https://images.unsplash.com/photo-1559839734-2b716b178d9a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1NzI0NTZ8MHwxfHNlYXJjaHwxNXx8ZG9jdG9yfGVufDB8fHx8MTcwNjU1NjY4N3ww&ixlib=rb-4.0.3&q=80&w=400", // Reusing dummy images
    rating: 4.9,
...
const GynecologyDoctorsScreen = () => {
  ...
  useEffect(() => {
    let filtered = ALL_GYNECOLOGY_DOCTORS.filter(
      (doctor) =>
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      {/* Custom Header (Same as Cardiology/Dermatology, but with "Gynecology" title) */}
...
const styles = StyleSheet.create({
  ...
  // Custom Header (Consistent with Cardiology/Dermatology)
  header: {
    flexDirection: "row",
    alignItems: "center",
    ...
    paddingVertical: 10,
    backgroundColor: COLORS.background, // Match screen background as per image
  ...
  // Sort & Filter Options (Consistent)
  optionsContainer: {
    flexDirection: "row",
    alignItems: "center",
    marginHorizontal: 20,
...
export default GynecologyDoctorsScreen;
