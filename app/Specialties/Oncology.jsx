// app/oncology-doctors.js (or app/doctors/oncology.js if using static routes)
...
// Dummy Data for Oncology Doctors
const ALL_ONCOLOGY_DOCTORS = [
  {
    id: "onc1",
...
const OncologyDoctorsScreen = () => {
  ...
  useEffect(() => {
    let filtered = ALL_ONCOLOGY_DOCTORS.filter(
      (doctor) =>
      ...
      >
        {displayedDoctors.length > 0 ? (
          ...
          <View style={styles.noResultsContainer}>
            {/* Using brain or a generic medical icon for oncology if specific cancer icon isn't available widely */}
            <MaterialCommunityIcons
              name="brain"
              size={60}
              color={COLORS.textSecondary}
              style={{ opacity: 0.6 }}
            />
            <Text style={styles.noResultsText}>No Oncology Doctors Found</Text>
...
const styles = StyleSheet.create({
  ...
  // Custom Header (Consistent with all previous screens)
  header: {
    flexDirection: "row",
    alignItems: "center",
...
export default OncologyDoctorsScreen;
