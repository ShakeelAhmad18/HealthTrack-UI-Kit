// app/appointments/cancel.js (or app/cancel-appointment-screen.js)
...
const CancelAppointmentScreen = () => {
  ...
  const params = useLocalSearchParams(); // To potentially get appointment ID if passed

  const [selectedReason, setSelectedReason] = useState(null);
  const [otherReasonText, setOtherReasonText] = useState("");
  const [isCancelling, setIsCancelling] = useState(false); // For loading state on button

  // Get appointment ID if passed, for context in cancellation
