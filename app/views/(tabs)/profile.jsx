...
const ProfileScreen = () => {
  ...
  const handleEditProfile = () => {
    router.push("views/profile/EditProfile");
  };
  ...
  const handleNotificationPress = () => {
    router.push("views/profile/NotificationSettings"); // Navigate to Notification settings screen
  ...
  const handlePasswordManagerPress = () => {
    router.push("views/profile/PasswordManager"); // Navigate to Password Manager screen
    setShowSettingsDropdown(false); // Close dropdown after navigation
  };
  ...
  const confirmLogout = () => {
    setShowLogoutModal(false); 
     router.replace('views/(auth)/sign-in'); 
  };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <ProfileOption
          ...
          text="Profile"
          onPress={() => router.push("views/profile/EditProfile")}
        />
        <ProfileOption
          iconName="heart-outline"
          text="Favorite"
          onPress={() => router.push("views/doctors/favorites")}
        />
        <ProfileOption
          iconName="credit-card-outline"
          text="Payment Method"
          onPress={() => router.push("views/profile/Payment")}
        />
        <ProfileOption
          iconName="lock-outline"
          text="Privacy Policy"
          onPress={() => router.push("views/profile/Privacy")}
        />
        ...
        <ProfileOption
          ...
          text="Help"
          onPress={() => router.push("views/profile/Help")}
        />
        <ProfileOption
          iconName="logout"
          text="Logout"
