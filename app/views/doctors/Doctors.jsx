  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.optionsContainer}>
        ...
        <TouchableOpacity style={styles.sortFilterButton} onPress={()=>router.push("views/doctors/Filters")}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("views/doctors/Rating")}
        >
          <Text
            style={[
              styles.sortFilterButtonText,
        ...
        {displayedDoctors.length > 0 ? (
          displayedDoctors.map((doctor) => (
            <TouchableOpacity
              ...
              onPress={() => router.push(`views/doctors/DoctorProfile`)}
            >
              <Image
              ...
              <View style={styles.doctorInfo}>
                ...
                <View style={styles.actionButtonsContainer}>
                  <TouchableOpacity
                    ...
                    onPress={() => router.push(`views/doctors/${doctor.id}`)}
                  >
